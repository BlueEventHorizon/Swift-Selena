...
- `.claude/commands/setting/create-code-headers.md` - Command定義
- `project/design/features/DES-004_swift_toc_generation_design.md` - 前身設計
- `meta/history/CONVERSATION_HISTORY.md` - DES-004の経緯
