...
- docs/docs_toc.md（ドキュメント索引）と同じパターンでswift_toc.md（コード索引）生成
...
**セクション構成**（docs/docs_toc.mdと同パターン）:
1. ヘッダー情報
...
1. **`.claude/commands/setting/create-docs_toc.md`作成**
...
**次のステップ**: `.claude/commands/setting/create-docs_toc.md`の詳細仕様策定
