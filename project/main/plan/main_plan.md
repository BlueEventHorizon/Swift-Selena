...
**詳細**: CHANGELOG.md、project/design/DES-103_Tool_Implementation_Design.md参照
...
**詳細**: CHANGELOG.md、project/design/DES-102_LSP_Integration_Design.md参照
...
**詳細**: CHANGELOG.md v0.5.3セクション、project/design/DES-102_LSP_Integration_Design.md参照
...
**詳細**: CONVERSATION_CHANGELOG.md v0.5.4セクション参照
...
**詳細**: LATEST_CONVERSATION_CHANGELOG.md、MCP_LSP_LEARNINGS.md参照
...
**詳細**: project/design/features/DES-006_code_header_db_design_v2.md参照
...
**詳細**: project/design/DES-102_LSP_Integration_Design.md Section 21参照

---

### v0.6.3（メタツールパターン）✅ 完了

**目標**: Anthropic「コード実行パターン」適用によるトークン消費削減
...
3. **環境変数でモード切替**
   - デフォルト: メタツールモード（4ツール）
   - `SWIFT_SELENA_LEGACY=1`: 従来モード（12ツール）

**ツール総数**: 公開4ツール（内部11ツール利用可能）
...
**詳細**: project/design/DES-102_LSP_Integration_Design.md Section 22参照
...
**詳細**: project/design/features/DES-006_code_header_db_design_v2.md Section 22参照
...
**詳細設計**: project/design/DES-102_LSP_Integration_Design.md
...
**詳細設計**: project/design/features/DES-006_code_header_db_design_v2.md
...
**詳細設計**: project/design/DES-102_LSP_Integration_Design.md Section 21
...
**詳細設計**: project/design/DES-102_LSP_Integration_Design.md Section 22
...
**詳細設計**: project/design/features/DES-006_code_header_db_design_v2.md Section 22
...
- **[CONVERSATION_CHANGELOG.md](CONVERSATION_CHANGELOG.md)** - 設計経緯
